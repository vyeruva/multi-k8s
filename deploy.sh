docker build -t reddyshack/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t reddyshack/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t reddyshack/multi-worker:$SHA -f ./worker/Dockerfile ./worker
